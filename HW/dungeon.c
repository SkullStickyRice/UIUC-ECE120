...
main ()
{
   ...
   /***************/
      ...
      while ( room < 5 )	/* Explore the maze */
      {
	   ...
	   {
	     printf("There is a mystery box in this room");
	     printf("you can choose to find th box or go on");
	     printf("Enter 0 to find the box, others to continue");
	     scanf("%d", &choice);
	     if (choice == 1 ) {room = 3; }
	     if (choice == 2 ) {room = 1; }
	     if (choice == 3 ) {room = 2; }
		...
		if (!key)
		{
		printf("you found the mystery box!");
		find = 1;
		}
		else
		{
		printf("you didn't find the mystery box.");
		}
		room = 5;
	     }
